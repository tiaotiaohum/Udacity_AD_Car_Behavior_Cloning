...
random.shuffle(sample) # shuffle the images after read them all, and before the test_train split, m
    ...
    while 1: # Loop forever so the generator never terminates
        ...
        for offset in range(0, num_samples, batch_size):
            ...
            for batch_sample in batch_samples:
                ...
                images.append(np.fliplr(center_image)) #flip the image, m
                angles.append(-center_angle) # the steering angle reverse, m
...
model.add(... finish defining the rest of your model architecture here ...) # TODO, m
